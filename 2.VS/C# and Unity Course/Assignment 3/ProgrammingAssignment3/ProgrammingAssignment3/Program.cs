    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (input[0] != 'q')
            {
                ...
                Card player1Card1 = a.TakeTopCard();
                Card player2Card1 = a.TakeTopCard();
                Card player3Card1 = a.TakeTopCard();
                Card player4Card1 = a.TakeTopCard();
                Card player1Card2 = a.TakeTopCard();
                Card player2Card2 = a.TakeTopCard();
                Card player3Card2 = a.TakeTopCard();
                Card player4Card2 = a.TakeTopCard();

                // deal 1 more card to players 2 and 3
                Card player2Card3 = a.TakeTopCard();
                Card player3Card3 = a.TakeTopCard();
                ...
                Console.WriteLine(player2Card3.Rank + "," + player2Card1.Suit);
